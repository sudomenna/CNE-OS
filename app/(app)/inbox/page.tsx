...
export default async function InboxPage({ searchParams }: InboxPageProps) {
  ...
  return (
    <RealtimeProvider userId={userId}>
      <div className="flex h-[calc(100vh-4rem)] overflow-hidden border border-border rounded-lg bg-card">
        {/* Coluna esquerda: lista de conversas (1/4) */}
        <aside
          className="w-1/4 min-w-56 border-r border-border flex flex-col overflow-hidden"
        ...
        <aside
          className="w-1/4 min-w-56 border-l border-border overflow-y-auto"

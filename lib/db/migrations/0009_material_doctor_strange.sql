...
ALTER TABLE "automation_action" ADD CONSTRAINT "automation_action_node_id_automation_node_id_fk" FOREIGN KEY ("node_id") REFERENCES "public"."automation_node"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "automation_condition" ADD CONSTRAINT "automation_condition_node_id_automation_node_id_fk" FOREIGN KEY ("node_id") REFERENCES "public"."automation_node"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
ALTER TABLE "automation_trigger" ADD CONSTRAINT "automation_trigger_node_id_automation_node_id_fk" FOREIGN KEY ("node_id") REFERENCES "public"."automation_node"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
CREATE INDEX "idx_automation_action_kind" ON "automation_action" USING btree ("kind");--> statement-breakpoint
...
CREATE INDEX "idx_automation_trigger_kind" ON "automation_trigger" USING btree ("kind");
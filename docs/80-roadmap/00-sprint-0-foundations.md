...
| T-0-07 | Schema permission + role_permission + matriz | D | ✅ done | (Onda D) |
| T-0-08 | Supabase RLS policies Fase 1 | E | ✅ done | (Onda E) |
| T-0-09 | Helpers requireSession, requirePermission | E | ✅ done | (Onda E) |
